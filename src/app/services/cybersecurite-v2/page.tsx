export default function CybersecuritePage() {
    ...
    return (
        <section
            className="bg-[var(--color-bg-light)] bg-cover bg-center bg-no-repeat text-[var(--color-text-dark)] md:bg-fixed"
            style={{
                backgroundImage:
                    "url('/images/background-cybersecurite.png')",
            }}
        >
            <div className="bg-[rgba(234,247,252,0.48)]">
                <div className="mx-auto max-w-7xl px-6 py-20">
                    <div className="mb-14 max-w-4xl rounded-3xl border border-[var(--color-border-soft)] bg-[rgba(238,243,247,0.9)] p-8 shadow-sm backdrop-blur-sm md:p-10">
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        {cybersecuriteTopics.map((topic) => (
                            <article
                                key={topic.title}
                                className="rounded-3xl border border-[var(--color-border-soft)] bg-[rgba(238,243,247,0.9)] p-8 shadow-sm backdrop-blur-sm"
                            >
